    ...
    <div className="pt-24 pb-16">
      ...
      <section className="bg-gradient-luxury py-20 relative overflow-hidden">
        <div className="absolute inset-0 opacity-20 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#D4AF37] rounded-full blur-[150px]" />
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-5 relative sticky top-32">
              <div className="aspect-[3/4] rounded-2xl overflow-hidden glass shadow-2xl relative border border-[#D4AF37]/20">
                <Image 
                  src="/acharya.jpg" 
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#200122]/90 via-transparent to-transparent opacity-80" />
              </div>
              <div className="absolute -bottom-6 -right-6 glass-dark p-6 rounded-xl border border-[#D4AF37]/20 shadow-xl max-w-[250px]">
                <p className="text-[#D4AF37] font-serif italic text-lg leading-snug">
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="prose prose-lg prose-headings:font-serif prose-headings:text-foreground text-foreground/80 max-w-none">
                <p>
                  Acharya Shri Shiv Kumar Shukla is a highly respected Vedic astrologer with over <strong>45 years of experience</strong> in the field of astrology and spiritual guidance.
                </p>
                <p>
              ...
              <div className="grid sm:grid-cols-2 gap-4 my-8">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 p-4 rounded-xl glass border border-black/5 hover:border-[#D4AF37]/30 transition-colors">
              ...
              <div className="prose prose-lg text-foreground/80 max-w-none">
                <p>
                  Every consultation is approached with <strong>sincerity, compassion, and complete confidentiality</strong>. At Shiva Astro Solutions, the focus is on delivering authentic astrological guidance that empowers individuals to make informed decisions and navigate life's challenges with greater confidence.
                </p>
                <p>
